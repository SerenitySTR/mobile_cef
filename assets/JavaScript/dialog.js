...
function TestDialogsMobile() {
    Dialog.Show({
        DialogId: 1,
        Type: "message",
        Title: "Інформація",
        Text: "Це тестовий інформаційний діалог для перевірки мобільної landscape-адаптації.",
        Buttons: [
            {
                Id: 1,
                Text: "Добре",
    ...
    setTimeout(function() {
        Dialog.Hide(function() {
            Dialog.Show({
                ...
                Type: "message",
                Title: "Підтвердження",
                Text: "Ви дійсно хочете продовжити?",
                Buttons: [
                    {
                        Id: 1,
                        Text: "Так",
            ...
            setTimeout(function() {
                Dialog.Hide(function() {
                    Dialog.Show({
                        ...
                        Type: "message",
                        Title: "Оберіть дію",
                        Text: "Перевірка розміщення трьох кнопок на мобільному пристрої.",
                        Buttons: [
                            {
                                Id: 1,
                                Text: "Прийняти",
...
function TestInputDialogMobile() {
    Dialog.Show({
        DialogId: 4,
        Type: "input",
        Title: "Введення тексту",
        Text: "Введіть нікнейм гравця",
        Placeholder: "Наприклад: John_Smith",
        Buttons: [
            {
                Id: 1,
                Text: "Підтвердити",
    ...
    setTimeout(function() {
        Dialog.Hide(function() {
            TestPasswordDialogMobile();
        });
    }, 2500);
}

function TestPasswordDialogMobile() {
    Dialog.Show({
        DialogId: 5,
        Type: "password",
        Title: "Авторизація",
        Text: "Введіть пароль від вашого акаунта",
    ...
    setTimeout(function() {
        Dialog.Hide(function() {
            TestListDialogMobile();
        });
    }, 2500);
}

function TestListDialogMobile() {
    Dialog.Show({
        DialogId: 6,
        Type: "list",
        Title: "Виберіть місто",
        Text: "Оберіть один із доступних варіантів",
        Items: [
            {
                Id: 1,
                Title: "Лос-Сантос",
                Description: "Основне місто"
            },
            {
                Id: 2,
                Title: "Сан-Фієрро",
                Description: "Західне місто"
            },
            {
                Id: 3,
                Title: "Лас-Вентурас",
                Description: "Місто розваг"
            },
            {
                Id: 4,
                Title: "Паломіно-Крік",
                Description: "Невелике містечко"
            },
            {
                Id: 5,
                Title: "Монтгомері",
                Description: "Сільська місцевість"
            },
            {
                Id: 6,
                Title: "Діллімор",
                Description: "Передмістя Лос-Сантоса"
            },
            {
                Id: 7,
                Title: "Ейнджел-Пайн",
                Description: "Місто біля гори Чиліад"
            }
        ],
        Buttons: [
            {
    ...
    setTimeout(function() {
        Dialog.Hide(function() {
            TestTablistDialogMobile();
        });
    }, 3500);
}

function TestTablistDialogMobile() {
    Dialog.Show({
        DialogId: 7,
        Type: "tablist",
        Title: "Гравці онлайн",
        ...
        Items: [
            {
                Id: 0,
                Values: ["0", "Serenity", "12", "34"]
            },
            {
                Id: 1,
                Values: ["1", "Alex_Williams", "8", "56"]
            },
            {
                Id: 2,
                Values: ["2", "Kate_Rivera", "15", "72"]
            },
            {
                Id: 3,
                Values: ["3", "Maksim_Dudka", "6", "48"]
            },
            {
                Id: 4,
                Values: ["4", "Tony_Barrera", "20", "91"]
            },
            {
                Id: 5,
                Values: ["5", "Sofia_Moore", "11", "37"]
            },
            {
                Id: 6,
                Values: ["6", "John_Smith", "4", "66"]
            },
            {
                Id: 7,
                Values: ["7", "Emily_Stone", "18", "43"]
            }
        ],
        Buttons: [
            {
