var AdminPanel = {
    root: null, tab: "stats", filter: "mine", selectedTicket: null, query: "", chatOpen: false, itemCategory: "weapons", pendingClaimTicket: null, quickOpen: false,
    ...
    Click: function(e){
        ...
        if(b.dataset.adminFilter){this.filter=b.dataset.adminFilter;this.selectedTicket=null;this.chatOpen=false;this.Render();return;}
        ...
        if(b.dataset.adminBack!==undefined){this.chatOpen=false;this.quickOpen=false;this.Render();return;}
        if(b.dataset.adminQuickToggle!==undefined){this.quickOpen=!this.quickOpen;this.Render();return;}
        if(b.dataset.adminQuick!==undefined){var q=this.quickReplies[Number(b.dataset.adminQuick)],d=this.Q("[data-admin-draft]");if(q&&d){d.value=q.text;this.quickOpen=false;d.focus();}return;}
