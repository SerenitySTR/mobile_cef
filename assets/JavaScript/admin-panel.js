var AdminPanel = {
    root: null, tab: "stats", filter: "mine", selectedTicket: null, query: "", chatOpen: false, itemCategory: "weapons",
    ...
    Action: function(action){
        ...
        if(action==="claim"){this.Send("admin:ticket:claim",{TicketId:Number(ticketId)});return;}
