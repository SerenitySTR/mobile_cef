...
setTimeout(()=>{
    Notifications.Toast({
        Type:"Success",
        Title:"Зарплата отримана!",
        Text:"Ви отримали 2 500$",
        Duration:5000
    });
},1000);
...
setTimeout(()=>{
    Notifications.Toast({
        Type:"Warning",
        Title:"Увага!",
        Text:"Порушення швидкісного режиму",
        Duration:5000
    });
},1800);
...
setTimeout(()=>{
    Notifications.Toast({
        Type:"Error",
        Title:"Помилка",
        Text:"У вас немає ключів від цього транспорту",
        Duration:5000
    });
},2600);
...
setTimeout(()=>{
    Notifications.Banner({
        ...
        Label:"НОВЕ ЗАВДАННЯ",
        Title:"Автошкола",
        Text:"Відвідайте автошколу та отримайте водійські права.",
        Subtext:"GPS позначено на карті",
        Duration:7000
    });
},3400);
...
setTimeout(()=>{
    Notifications.Reward({
        Type:"Success",
        Title:"Ви отримали 1 000$",
        Text:"За активну гру на сервері",
        Duration:6000
    });
},4300);
